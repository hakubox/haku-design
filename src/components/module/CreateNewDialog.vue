  ...
  appTypeList: [
    {
      ...
      backgroundImage: 'https://cdn.hakuq.com/assets/image/create-questionnaire.webp',
    },
    {
      title: '画布',
      type: 'canvas',
      description: '创建新的空白画布',
      backgroundImage: 'https://cdn.hakuq.com/assets/image/create-canvas.webp',
    },
    // {
    //   title: '复合组件',
    //   type: 'complex-component',
    //   description: '创建新的可复用组件',
    //   backgroundImage: 'https://cdn.hakuq.com/assets/image/create-component.webp',
    // },
    // {
    //   title: '课件',
    //   type: 'courseware',
    //   description: '创建新的课件',
    //   backgroundImage: 'https://cdn.hakuq.com/assets/image/create-courseware.webp',
    // },
  ],
  /** 提交表单 */
  formState: {
