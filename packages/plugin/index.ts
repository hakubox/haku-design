...
import { PluginInstance, PluginDependency } from './src/@types';
import { message, compareVersion } from '@haku-design/common';
import { PluginType, PluginStatus } from './src/enum';

export type { PluginInfo, PluginDependency } from './src/@types';
export { PluginType, PluginStatus, PluginLoadType } from './src/enum';
export { registerPlugin } from './src/register-plugin';
export { registerComponent, registerMenu } from './src/register-component';
export { registerEditor } from './src/register-editor';
export { registerEventTrigger, registerEventAction } from './src/register-event';
