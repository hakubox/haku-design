...
import { type SimpleAnime, type SimpleAnimeConfig, simpleAnimeList } from '@haku-design/anime';
import GeneralEditor from '@haku-design/core/src/components/general-config/GeneralEditor.vue';
import { ComponentPropertyEditor, type GeneralProperty } from '@haku-design/core';
