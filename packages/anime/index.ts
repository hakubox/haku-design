import { type SetPartial } from '@haku-design/core';
import { getAudioFile, getAudioImg } from '@haku-design/common/src/lib/audio';
import { createModelId } from '@haku-design/common';
import { Howl } from 'howler';
import { reactive } from 'vue';
import type { AudioTimelineFragment, ComponentTimelineFragment, KeyFrame, SimpleAnimeConfig, TimeAxis, TimelineFragment, TimelineTrack } from './src/@types';
import { simpleAnimeList } from './src/data/simple-anime';

export { simpleAnimeList } from './src/data/simple-anime';
