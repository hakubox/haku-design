...
import { themePropertys } from './src/data/theme-propertys';
import { cloneLoop } from '@haku-design/common';
import { themeList } from './src/data/theme-list';
...
export const service = {
  ...
  loadCSS(css: string) {
    render(css).then((val) => {
      ...
      message.toast('LESS代码编译出错', 'error');
      // notification.error({
      //   message: 'LESS代码编译出错',
